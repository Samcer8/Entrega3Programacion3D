...
struct Enemy : Entity {
	...
	Enemy(Mesh mesh, int maxHealth, int damage, int speed, Vec3 pos = F32.Zero);
	Enemy(Texture tex, int maxHealth, int damage, int speed, Player& target, Vec3 pos = F32.Zero);
